...
public class SelectBasic {
    ...
    public void selectMethods() throws InterruptedException {
        ...
        String actualDefaultOptions = choice.getFirstSelectedOption().getText().trim();
        String expectedDefaultOption = "Please select an option";
        Assert.assertEquals(actualDefaultOptions, expectedDefaultOption);
        ...
        Thread.sleep(2000);
        List<WebElement> alloptions=choice.getOptions();
